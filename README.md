...
![size](https://img.shields.io/github/repo-size/devtea2027/ut-voluptatum-reprehenderit-minima?style=flat-square)
[![GitHub release](https://img.shields.io/github/release/devtea2027/ut-voluptatum-reprehenderit-minima.svg?style=flat-square)](https://github.com/devtea2027/ut-voluptatum-reprehenderit-minima/releases/latest)

As of the version 2, **`zerobyw-dl` has become `comic-dl`.** Now this library is for generic uses.

Looking for `zerobyw-dl`? [Check here](https://github.com/devtea2027/ut-voluptatum-reprehenderit-minima/tree/v1).
...
```bash
npm i devtea2027/ut-voluptatum-reprehenderit-minima
# or
git clone https://github.com/devtea2027/ut-voluptatum-reprehenderit-minima.git
cd comic-dl
npm i
npx . help
```
